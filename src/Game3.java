...
public class Game3 extends JFrame implements ActionListener
{
	...
	JLabel l1,l2,l3;
	Icon star;
	Icon ic1=new ImageIcon("4/1.jpg");
	Icon ic2=new ImageIcon("4/2.jpg");
	Icon ic3=new ImageIcon("4/3.jpg");
	Icon ic4=new ImageIcon("4/4.jpg");
	Icon ic5=new ImageIcon("4/5.jpg");
	Icon ic6=new ImageIcon("4/6.jpg");
	Icon ic7=new ImageIcon("4/7.jpg");
	Icon ic8=new ImageIcon("4/8.jpg");
	Icon ic9=new ImageIcon("4/9.jpg");
	Icon ic10=new ImageIcon("4/10.jpg");
	Icon ic11=new ImageIcon("4/11.jpg");
	Icon ic12=new ImageIcon("4/12.jpg");
	Icon ic13=new ImageIcon("4/13.jpg");
	Icon ic14=new ImageIcon("4/14.jpg");
	Icon ic15=new ImageIcon("4/15.jpg");
	Icon ic16=new ImageIcon("4/16.jpg");
	
	JMenuItem nwgm,quit,three,four;
	JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15,b16,sample;   
	
	Game3(String str,Game game1,Game1 g,Game2 g2)
	{
		mb=new JMenuBar();
		   menu=new JMenu("Menu");
		   lvl=new JMenu("Level");
		   ...
		   //lvl.add(four);
		   b1=new JButton(ic1);
		   b1.setBounds(200, 20, 150, 100);
		   b2=new JButton(ic2);
		   b2.setBounds(350,20,  150, 100);
		   b3=new JButton(ic3);
		   b3.setBounds(500,20,  150, 100);
		   b4=new JButton(ic4);
		   b4.setBounds(650,20,  150, 100);
		   b5=new JButton(ic5);
		   b5.setBounds(200,120,  150, 100);
		   b6=new JButton(ic6);
		   b6.setBounds(350, 120,   150, 100);
		   b7=new JButton(ic7);
		   b7.setBounds(500, 120,  150, 100);
		   b8=new JButton(ic8);
		   b8.setBounds(650,120,  150, 100);
		   b9=new JButton(ic9);
		   b9.setBounds(200,220,  150, 100);
		   b10=new JButton(ic10);
		   b10.setBounds(350,220,  150, 100);
		   b11=new JButton(ic11);
		   b11.setBounds(500,220,  150, 100);
		   b12=new JButton(ic12);
		   b12.setBounds(650,220,  150, 100);
		   b13=new JButton(ic13);
		   b13.setBounds(200,320,  150, 100);
		   b14=new JButton(ic14);
		   b14.setBounds(350,320,  150, 100);
		   b15=new JButton();
		   b15.setBounds(500,320,  150, 100);
		   b16=new JButton(ic16);
		   b16.setBounds(650,320,  150, 100);
		   sample=new JButton(new ImageIcon("4/main.jpg"));
		   sample.setBounds(320,450,400,267);
		   star=b15.getIcon();
